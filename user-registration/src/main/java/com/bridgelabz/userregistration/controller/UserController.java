...
public class UserController {
	...
	public ResponseEntity<ResponseClass> updateUser(@RequestHeader String token, @RequestParam String firstName,
			@RequestParam String lastName, @RequestParam String kyc, @RequestParam @NotBlank String email,
			@RequestParam @NotBlank String dateOfBirth) {
		ResponseClass responseClass = iUserService.updateUser(token, firstName, lastName, kyc, email, dateOfBirth);
		return new ResponseEntity<>(responseClass, HttpStatus.OK);
	}
	 ...
	 * @Param token
	 */
	@PostMapping("/activateUserByOtp")
	public ResponseEntity<ResponseClass> activateUserByOtp(@RequestHeader String token) {
		ResponseClass responseClass = iUserService.activateUserByOtp(token);
		return new ResponseEntity<>(responseClass, HttpStatus.OK);
	}
