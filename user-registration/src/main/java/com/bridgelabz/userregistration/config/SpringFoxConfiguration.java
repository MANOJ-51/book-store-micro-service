...
public class SpringFoxConfiguration {
	...
	Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
				...
				.apis(RequestHandlerSelectors.basePackage("com.bridgelabz.userregistration.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Book Store User Service", "APIs for E.", "1.0", "Terms of service",
				new Contact("Book Store User Service", "http://bridgelabz.com&quot;", "m4anoj51@gmail.com"), "Apache 2.0",
